...
unsigned int nStakeMinAge = 8 * 60 * 60 ; //Minimum stake age 8 hours
unsigned int nStakeMaxAge = 24 * 60 * 60 * 45; //Maximum stake age 45days

unsigned int nModifierInterval = 10 * 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 12; //Coin Base Maturity
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
            ...
            int64_t nSubsidy = 56 * COIN; //Miner reward

            if(nBestHeight == 0)
            {
            nSubsidy = 786666 * COIN; //Total premine coin
            }
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("");
        bnProofOfWorkLimit = bnProofOfWorkLimitTestNet; // 16 bits PoW target limit for testnet
        nStakeMinAge = 1 * 60 * 60; // test net min age is 1 hour
        nCoinbaseMaturity = 12; // test maturity is 10 blocks
    }
    else
    {
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "21may2017";
        CTransaction txNew;
        txNew.nTime = 1495391006;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1495391006;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 754193 : 754193;
        ...
        assert(block.hashMerkleRoot == uint256("0x95153698978c4d6dfd92abc02c841f3b3649ceda606cd9734029e51deac75bbe"));
